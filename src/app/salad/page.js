        ...
        <section className="pt-32 pb-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                <p className="text-lg md:text-xl text-[#4a4a4a] font-light italic max-w-3xl mx-auto text-center mb-12 leading-relaxed tracking-wide">
                    Fresh, vibrant, and full of flavor — our salad selections are crafted with crisp greens,
                    premium ingredients, and homemade dressings for a refreshing start or perfect pairing to your meal.
                </p>
